...
class UAEBeaches extends StatefulWidget {
  const UAEBeaches({super.key});

  @override
  State<UAEBeaches> createState() => _UAEBeachesState();
}

class _UAEBeachesState extends State<UAEBeaches> {
